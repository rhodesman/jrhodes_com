...
soundManager.setup({
  url: window.History.getBaseHref() + "js/",
  preferFlash: false,
  useHTML5Audio: true,
  flashLoadTimeout: 0,
  onready: function() {
    ...
    while (window.sound.queuedSounds.length) {
      soundManager.createSound(window.sound.queuedSounds.pop());
    }
...
;(function($) {
  ...
  $(function() {
    ...
    var $body = $(document.body),
      ...
      stateQueue = [],
      sounds = {
        gamesButton: sound(baseUrl + "snds/voice/kids/CG_Game-NavigationButtons_Games_2Kids" + audioExt),
        storiesButton: sound(baseUrl + "snds/voice/kids/CG_Game-NavigationButtons_Stories_2Kids" + audioExt),
        createButton: sound(baseUrl + "snds/voice/kids/CG_Game-NavigationButtons_Create_2Kids" + audioExt),
        curiousButton: sound(baseUrl + "snds/voice/kids/CG_Game-NavigationButtons_Curious_2Kids" + audioExt),
        likeButton: sound(baseUrl + "snds/voice/kids/CG_Game-NavigationButtons_ILikeThis_Girl" + audioExt)
      };
    ...
    var buildList = function(parent, list, man, manIsSpeaking, smallPerPage, largePerPage) {
      ...
      update = function() {
        ...
        $("a", list).each(function() {
          ...
          if (isUnreleased) {
            audio = "snds/voice/kids/CG_Game-NavigationButtons_ComingSoon_Boy_1";
          }
    ...
    var doPage = {
      ...
      games: function() {
        // Prepare variables
        var prefix = "snds/voice/man/CG-ManInYellowHat_WonderBean_SiteNavigation_",
        ...
        if (isPlayer && !$("object", container).length && !Modernizr.canvas) {
          ...
          buildGameSelector(isPlayer, 8, (!isPlayer) ? {
            ...
            intro: { file: "snds/voice/man/Site_Nav-M_00" + (isThemePlayer ? "6" : "3"),   length: 4000 },
            more:  { file: prefix + "GamesPlayingPage_VO_1_05",                            length: 2000 },
            extra: { file: "snds/voice/kids/Gen-Nav-C_016" }
          }, false);
        }
      },
      ...
      stories: function() {
        ...
        buildGameSelector(isPlayer, 8, (!isPlayer) ? {
          ...
          intro: { file: "snds/voice/man/Site_Nav-M_00" + (isThemePlayer ? "6" : "4"),     length: 3000 },
          less:  { file: prefix + "StoriesPlayingPage_VO_1_14-noNav",                      length: 7000 },
          extra: { file: "snds/voice/kids/Gen-Nav-C_017" }
        }, false);
      },
      ...
      create: function() {
        ...
        if (isPlayer && !$("object", container).length && !Modernizr.canvas) {
          ...
          buildGameSelector(isPlayer, 8, (!isPlayer) ? {
            ...
            intro: { file: "snds/voice/man/Site_Nav-M_00" + (isThemePlayer ? "6" : "5"),    length: 3000 },
            less:  { file: prefix + "CreatePlayingPage_VO_1_05-noNav",                      length: 7000 },
            extra: { file: "snds/voice/kids/Gen-Nav-C_018" }
          }, false);
        }
      },
      ...
      themes: function(page) {
        ...
        buildGameSelector(isPlayer, $("#themes").length ? 8 : 6, isPlayer ? {
          intro: { file: "snds/voice/man/Site_Nav-M_00" + (isMobile ? "7" : "6"), length: 4000 }
        } : themeElements.length ? {
          intro: { file: prefix + "CuriousAbout_AllThemesPage_VO_1_03", length: 2000 },
     ...
     */
    function runPage() {
      if (urlSegments[0] == "index.html") urlSegments[0] = "";
      if (!urlSegments[0]) {
    ...
    var processStateQueue = function() {
      ...
      /*if (!nextUrlSegments[0]) {
        nextUrlSegments[0] = "home";
        relativeUrl = "home" + relativeUrl;
        url += "home";
      } else if (nextUrlSegments[0] == "index") {
        nextUrlSegments[0] = "home";
        relativeUrl = relativeUrl.replace("index", "home");
        url = url.replace("index", "home");
      }*/
      //if (nextUrlSegments[0] == "index.html") nextUrlSegments[0] = "";
      ...
      $.when.apply($, transitions.concat([$.ajax({
        ...
        success: function(data) { content = $($(data).find("#content")[0].innerHTML) },
